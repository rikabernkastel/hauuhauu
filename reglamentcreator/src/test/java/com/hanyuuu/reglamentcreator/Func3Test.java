...
public class Func3Test {
	...
	public void test() {
		 ...
		 * на соответствующих уровнях: 950, 316, 1391.
		 * Ожидается, что будет произведен следующий расчет: (950*1+316*2+1391*3) и возвращено значение 5755
		 */
		/**
		 ...
		 */
		assertEquals(a.takeSum(950, 316, 1391),5755);
	}
