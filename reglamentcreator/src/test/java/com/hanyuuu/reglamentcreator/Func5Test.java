...
public class Func5Test {
	...
	public void test() {
		 ...
		 * на соответствующих уровнях: 964, 1436, 955.
		 * Ожидается, что будет произведен следующий расчет: (964*1+1436*2+955*3) и возвращено значение 6701
		 */
		/**
		 ...
		 */
		assertEquals(a.takeSum(964, 1436, 955),6701);
	}
