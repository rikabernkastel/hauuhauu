...
public class Func14Test {
	...
	public void test() {
		...
		* на соответствующих уровнях: 1199,586,1928. 
		* Ожидается, что будет произведен следующий расчет: (1199*1+586*2+1928*3) и возвращено значение 8155 
		*/ 
		/** 
		...
		*/ 
		assertEquals(a.takeSum(1199,586,1928),8155);
	}
