...
public class Func8Test {
	...
	public void test() {
		 ...
		 * на соответствующих уровнях: 1234, 251, 1335.
		 * Ожидается, что будет произведен следующий расчет: (1234*1+251*2+1335*3) и возвращено значение 5741
		 */
		/**
		 ...
		 */
		assertEquals(a.takeSum(1234, 251, 1335),5741);
	}
