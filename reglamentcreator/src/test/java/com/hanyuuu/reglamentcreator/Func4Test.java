...
public class Func4Test {
	...
	public void test() {
		 ...
		 * на соответствующих уровнях: 567, 1504, 1286.
		 * Ожидается, что будет произведен следующий расчет: (567*1+1504*2+1286*3) и возвращено значение 7433
		 */
		/**
		 ...
		 */
		assertEquals(a.takeSum(567, 1504, 1286),7433);
	}
