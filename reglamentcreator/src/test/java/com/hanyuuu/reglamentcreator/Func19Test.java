...
public class Func19Test {
	...
	public void test() {
		 ...
		 * на соответствующих уровнях: 1478,910,633.
		 * Ожидается, что будет произведен следующий расчет: (1478*1+910*2+633*3) и возвращено значение 5197
		 */
		/**
		 ...
		 */
		assertEquals(a.takeSum(1478,910,633),5197);
	}
