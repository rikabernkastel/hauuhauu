...
public class Func13Test {
	...
	public void test() {
		 ...
		 * на соответствующих уровнях: 523, 1248, 2379.
		 * Ожидается, что будет произведен следующий расчет: (523*1+1248*2+2379*3) и возвращено значение 4150
		 */
		/**
		 ...
		 */
		assertEquals(a.takeSum(523, 624, 793),4150);
	}
